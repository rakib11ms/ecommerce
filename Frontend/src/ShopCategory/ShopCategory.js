                ...
                <div className="row ">
                    ...
                    <div className="shop-category-main-wrapper ">
                        ...
                        <div className="shop-category-right-sidebar-wrapper ">
                            ...
                            <div className="">
                                <button className="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal1" onClick={() => setModalContent('modal content 1')}>click to show1</button>
                                <button className="btn btn-success mx-2" data-bs-toggle="modal" data-bs-target="#exampleModal2" onClick={() => setModalContent('modal content 2')}>click to show2</button>
                            </div>
